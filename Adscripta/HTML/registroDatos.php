    ...
    <main class="sugarads-main">
        ...
        <div class="sugarads-grid">
            <div class="sugarads-col-left">
                <!-- crear horario -->
                <form id="form-crear" class="formasig" method="post" action="../../PHP/registrarHorario.php" style="border-top:2px solid #c7b299; padding-top:1.5rem; max-width:400px;">
                    ...
                    <div class="sugarads-field">
                        ...
                        <select id="hor-hora" class="sasignacion1" name="hora" required>
            ...
            <div class="formasig" style="margin-top: 1rem; min-width: 800px;">
                <h2>Horarios Registrados</h2>
                <table class="pruebads">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Profesor</th>
